...
class OTPRequestController extends AppBaseController
{
    ...
    public function report(Request $request)
    {
        ...
        $otpRequests = $this->otpRequestRepository->getActivePaginated(25, 'id', 'desc');

        $count = $this->otpRequestRepository->count();
    ...
    public function search(Request $request)
    {
        ...
        if ($input['txtStartDate'] != '' && $input['txtEndDate'] != '' && $input['q'] != '') {
            ...
            $count = RequestLog::orderBy('id', 'desc')->count();
