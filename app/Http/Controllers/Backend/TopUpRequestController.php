...
class TopUpRequestController extends AppBaseController
{
    ...
    public function report(Request $request)
    {
        ...
        $otpRequests = $this->topUpRequestRepository->getActivePaginated(25, 'id', 'desc');

        $count = $this->topUpRequestRepository->count();

        return view('backend.topup.index')
    ...
    public function search(Request $request)
    {
        ...
        if ($input['txtStartDate'] != '' && $input['txtEndDate'] != '' && $input['q'] != '') {
            ...
            $count = RequestTopUpLog::orderBy('id', 'desc')->count();
