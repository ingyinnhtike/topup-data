...
use App\Http\Requests\ExcelDataPackRequest;
...
class ExcelDataTokenRequestController extends Controller
{
    use DataPack;
    ...
    public function index(Request $request)
    {
        ...
        $storePostRequest = new ExcelDataPackRequest();
        ...
        $package_id = Packages::where('package_code', $packageCode)->where('package_name', $packageName)->first()->id;
