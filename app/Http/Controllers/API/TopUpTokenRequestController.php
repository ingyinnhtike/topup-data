...
class TopUpTokenRequestController extends Controller
{
    use TopUp;
    ...
    public function index(Request $request)
    {
        ...
        $requestLog = RequestTopUpLog::where([
        ...
        $todaySumAmount = RequestTopUpLog::leftJoin('services', 'services.id', '=', 'request_top_up_log.service_id')
            ->where([
                ['service_id', '=', $serviceResult->id],
                ['request_top_up_log.merchant_id', '=', $uuIdResult->id],
                ['request_top_up_log.status', '=', 'success']
            ])
            ->whereDate('request_top_up_log.created_at', Carbon::today())
            ->sum('services.amount');
        ...
        $todaySumAmountPhone = RequestTopUpLog::leftJoin('services', 'services.id', '=', 'request_top_up_log.service_id')
            ->where([
                ['service_id', '=', $serviceResult->id],
                ['request_top_up_log.merchant_id', '=', $uuIdResult->id],
                ['request_top_up_log.status', '=', 'success'],
                ['request_top_up_log.to', '=', $to]
            ])
            ->whereDate('request_top_up_log.created_at', Carbon::today())
            ->sum('services.amount');
        ...
        $RequestLog = $this->saveTopUpLog($merchantRequestId, $requestId, $uuIdResult, $serviceResult, $to, $operator, $request->userDefined);
        ...
        switch ($operator) {
            ...
            case "MPT":
                ...
                try {
                    ...
                    // $body = $this->mpss($requestId, $phoneNumber, $amount, $operator, $serviceResult);

                    $body = $this->mpt($requestId, $phoneNumber, $amount, $operator, $serviceResult);
...
//                }
            ...
            case "ooredoo":
                ...
                try {
                    ...
                    $body = $this->ooredoo($requestId, $phoneNumber, $amount, $operator, $serviceResult);
...
//                }
            ...
            case "telenor":
                ...
                try {
                    ...
                    /**Telenor Top Up API**/
                    $body = $this->telenor($requestId, $phoneNumber, $amount, $operator, $serviceResult);
...
//                }
            ...
            default:
                ...
                try {
                    ...
                    if (in_array($uuIdResult->id, $mpssAllowId)) {
                        $body = $this->mpss($requestId, $phoneNumber, $amount, $operator, $serviceResult);
                    } else {
                        $phoneNumber = parse_phone_number($to);
                        $body = $this->mytel($requestId, $phoneNumber, $amount, $operator, $serviceResult);
                    }
...
//                }
        ...
        $this->updateTopUpLog($RequestLog, $body);
