    ...
    {{ Form::open(['route' => 'admin.access.user.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    {{ Form::label('password_confirmation', trans('validation.attributes.backend.access.users.merchant'), ['class' => 'col-lg-2 control-label']) }}

                    <div class="col-lg-10">
                        {{ Form::select('merchant_id', $merchant->pluck('name','id'), null,['class' => 'form-control', 'required' => 'required', 'placeholder' => trans('validation.attributes.backend.access.users.merchant')]) }}
                    </div><!--col-lg-10-->
                </div>
