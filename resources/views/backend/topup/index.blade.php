    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <form action="{!! route('admin.top.up.search') !!}" method="POST" class="form-inline" role="search">
                    {{ csrf_field() }}
        ...
        <br>
        <form class="form-horizontal" v-show="(show != 0) && (show != 3)" target="_blank" action="{!! route('admin.top.up.download') !!}" method="post">
            {!! csrf_field() !!}
