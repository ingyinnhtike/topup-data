<header class="main-header">
    ...
    <a href="{{ route('frontend.index') }}" class="logo">
        ...
        <span class="logo-lg">
            <!--<img src="/assets/img/BluePlanetLogo.png" alt="" style="width:90%;" />-->
            <img src="{{ url('uploads/general') .'/BoomSMSLogo.png' }}" alt="" style="width:70%;" />
        </span>
    </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="{!! route('admin.auth.logout') !!}" class="btn btn-danger btn-flat">
